...
public interface ITable<T> {
     ...
     * @param where
     * @return
     * @implNote has small performance advantage over {@link ITable#select(WhereClause)} because it does not convert all records to java objects
     */
     ...
     * @implNote has small performance advantage over {@link ITable#select(WhereClause)}.size() because it "SELECT COUNT(*)"
     */
