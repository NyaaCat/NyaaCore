...
public enum I18nItemName {
    ...
    WHITE_BED(Material.BED, 0, "item.bed.white.name"),
    ...
    SILVER_BED(Material.BED, 8, "item.bed.silver.name"),
    ...
    SILVER_GLAZED_TERRACOTTA(Material.SILVER_GLAZED_TERRACOTTA, "tile.glazedTerracottaSilver.name"),
    ...
    WHITE_CONCRETE(Material.CONCRETE, 0, "tile.concrete.white.name"),
    ...
    SILVER_CONCRETE(Material.CONCRETE, 8, "tile.concrete.silver.name"),
    ...
    WHITE_CONCRETE_POWDER(Material.CONCRETE_POWDER, 0, "tile.concretePowder.white.name"),
    ...
    SILVER_CONCRETE_POWDER(Material.CONCRETE_POWDER, 8, "tile.concretePowder.silver.name"),
